...
// Copyright (c) 2013 The zhongyingbi developers
...
uint256 hashGenesisBlock("0x00000edf6be1def215b33cdc164c6bb188573af00a43e628e6d988a33f27d7c0");
static const unsigned int timeGenesisBlock = 1495303035;
...
const string strMessageMagic = "zhongyingbi Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
       const char* pszTimestamp = "already in already databases we zhongyingbipark from USA with Transactions.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x6f4da9b011e79d3d5de048d2d93d20b5d528980a9676e5c5c1a2de71e5b28887"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("zhongyingbiMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("zhongyingbiMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("zhongyingbiMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("zhongyingbi-miner");
    ...
    try { loop {
        ...
        printf("Running zhongyingbiMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("zhongyingbiMiner terminated\n");
        throw;
    }
}
