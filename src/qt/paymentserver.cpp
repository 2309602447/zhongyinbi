...
const QString BITCOIN_IPC_PREFIX("zhongyingbi:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click zhongyingbi: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start zhongyingbi: click-to-pay handler");
    else
...
{
    // clicking on zhongyingbi: URLs creates FileOpen events on the Mac:
